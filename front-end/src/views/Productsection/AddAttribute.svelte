                ...
                <div class="flex flex-wrap">
                  ...
                  <div class="flex flex-wrap">
                    <div class="w-full lg:w-12/12 px-4" style="margin-block: 2%;">
                      <div class="relative w-full mb-3">
                          {#if objectId != "addattribute" }
                          <button type="submit" on:click|preventDefault={updateAttribute} class="btn btn-primary">
                            Update Attribute
                          </button>  
                          {:else}
                          <button type="submit" on:click|preventDefault={addAttribute} class="btn btn-primary">
                            Add Attribute
                          </button> 
                          {/if}
